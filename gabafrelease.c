...
#define nrn_init _nrn_init__gabafrelease
#define _nrn_initial _nrn_initial__gabafrelease
#define nrn_cur _nrn_cur__gabafrelease
#define _nrn_current _nrn_current__gabafrelease
#define nrn_jacob _nrn_jacob__gabafrelease
#define nrn_state _nrn_state__gabafrelease
#define _net_receive _net_receive__gabafrelease 
#define state state__gabafrelease 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_gabafrelease", _hoc_setdata,
 0, 0
};
 ...
 "Ves_gabafrelease", "mM",
 "Fmax_gabafrelease", "mM",
 "b_gabafrelease", "/mM4-ms",
 "u_gabafrelease", "/ms",
 "k1_gabafrelease", "/mM-ms",
 "k2_gabafrelease", "/ms",
 "k3_gabafrelease", "/ms",
 "kh_gabafrelease", "/ms",
 "depth_gabafrelease", "um",
 "taur_gabafrelease", "ms",
 "cainf_gabafrelease", "mM",
 "kt_gabafrelease", "mM/ms",
 "kd_gabafrelease", "mM",
 "FA_gabafrelease", "mM",
 "VA_gabafrelease", "mM",
 "T_gabafrelease", "mM",
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 gabafrelease gabafrelease.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "gabafrelease.mod";
static const char* nmodl_file_text = 
