...
#define nrn_init _nrn_init__achrelease
#define _nrn_initial _nrn_initial__achrelease
#define nrn_cur _nrn_cur__achrelease
#define _nrn_current _nrn_current__achrelease
#define nrn_jacob _nrn_jacob__achrelease
#define nrn_state _nrn_state__achrelease
#define _net_receive _net_receive__achrelease 
#define state state__achrelease 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_achrelease", _hoc_setdata,
 0, 0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 achrelease achrelease.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "achrelease.mod";
static const char* nmodl_file_text = 
