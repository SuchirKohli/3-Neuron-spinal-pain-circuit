...
#define cainf cainf_capump
 double cainf = 0.0001;
#define del del_capump
 double del = 0;
#define depth depth_capump
 double depth = 0.1;
#define tdur tdur_capump
 double tdur = 5;
#define taur taur_capump
 double taur = 200;
 ...
 "depth_capump", &depth_capump,
 "taur_capump", &taur_capump,
 "cainf_capump", &cainf_capump,
 "tdur_capump", &tdur_capump,
 "del_capump", &del_capump,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 capump capump.mod\n");
...
static const char* nmodl_file_text = 
  ...
  "	RANGE ca\n"
  "	GLOBAL depth,cainf,taur, tdur, del\n"
  "}\n"
  "\n"
  "UNITS {\n"
