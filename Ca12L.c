...
#define nrn_init _nrn_init__Ca12L
#define _nrn_initial _nrn_initial__Ca12L
#define nrn_cur _nrn_cur__Ca12L
#define _nrn_current _nrn_current__Ca12L
#define nrn_jacob _nrn_jacob__Ca12L
#define nrn_state _nrn_state__Ca12L
#define _net_receive _net_receive__Ca12L 
#define rates rates__Ca12L 
#define states states__Ca12L 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_Ca12L", _hoc_setdata,
 "rates_Ca12L", _hoc_rates,
 0, 0
};
 /* declare global and static user variables */
#define cao0 cao0_Ca12L
 double cao0 = 1.5;
#define cai0 cai0_Ca12L
 double cai0 = 0.000184;
#define tauh tauh_Ca12L
 double tauh = 59;
#define taum taum_Ca12L
 double taum = 10;
 ...
 "cai0_Ca12L", &cai0_Ca12L,
 "cao0_Ca12L", &cao0_Ca12L,
 "taum_Ca12L", &taum_Ca12L,
 "tauh_Ca12L", &tauh_Ca12L,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Ca12L Ca12L.mod\n");
...
static int  rates ( _threadargsprotocomma_ double _lv ) {
    minf = 1.0 / ( 1.0 + exp ( - ( _lv + 30.0 ) / 6.0 ) ) ;
   hinf = 1.0 / ( 1.0 + exp ( ( _lv + 80.0 ) / 6.4 ) ) ;
     return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "Ca12L.mod";
static const char* nmodl_file_text = 
  "NEURON {\n"
  "	SUFFIX  Ca12L\n"
