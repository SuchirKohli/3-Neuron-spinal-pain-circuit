...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 KV11 KV11HH.mod\n");
...
static int  rates ( _threadargsprotocomma_ double _lv ) {
    minf = 1.0 / ( 1.0 + exp ( - ( _lv + 30.5 ) / 11.3943 ) ) ;
   taum = 30.0 / ( 1.0 + exp ( ( _lv + 76.56 ) / 26.1479 ) ) ;
   hinf = 1.0 / ( 1.0 + exp ( ( _lv + 30.0 ) / 27.3943 ) ) ;
   tauh = 15000.0 / ( 1.0 + exp ( - ( _lv + 160.56 ) / 100.0 ) ) ;
     return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "KV11HH.mod";
static const char* nmodl_file_text = 
  "NEURON {\n"
  "	SUFFIX  KV11\n"
