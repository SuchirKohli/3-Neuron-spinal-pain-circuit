...
#define nrn_init _nrn_init__NaV12
#define _nrn_initial _nrn_initial__NaV12
#define nrn_cur _nrn_cur__NaV12
#define _nrn_current _nrn_current__NaV12
#define nrn_jacob _nrn_jacob__NaV12
#define nrn_state _nrn_state__NaV12
#define _net_receive _net_receive__NaV12 
#define kstates kstates__NaV12 
#define rates rates__NaV12 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_NaV12", _hoc_setdata,
 "rates2_NaV12", _hoc_rates2,
 "rates_NaV12", _hoc_rates,
 0, 0
};
#define rates2 rates2_NaV12
 extern double rates2( _threadargsprotocomma_ double , double , double , double );
 /* declare global and static user variables */
#define C1I1k2 C1I1k2_NaV12
 double C1I1k2 = -11;
#define C1I1v2 C1I1v2_NaV12
 double C1I1v2 = -65;
#define C1I1b2 C1I1b2_NaV12
 double C1I1b2 = 0.55;
#define C2O2k2 C2O2k2_NaV12
 double C2O2k2 = -15;
#define C2O2v2 C2O2v2_NaV12
 double C2O2v2 = -20;
#define C2O2b2 C2O2b2_NaV12
 double C2O2b2 = 0.13;
#define C2O1k2 C2O1k2_NaV12
 double C2O1k2 = -10;
#define C2O1v2 C2O1v2_NaV12
 double C2O1v2 = -10;
#define C2O1b2 C2O1b2_NaV12
 double C2O1b2 = 16;
#define C2C1k2 C2C1k2_NaV12
 double C2C1k2 = -10;
#define C2C1v2 C2C1v2_NaV12
 double C2C1v2 = -5;
#define C2C1b2 C2C1b2_NaV12
 double C2C1b2 = 16;
#define C2C1k1 C2C1k1_NaV12
 double C2C1k1 = 10;
#define C2C1v1 C2C1v1_NaV12
 double C2C1v1 = -35;
#define C2C1b1 C2C1b1_NaV12
 double C2C1b1 = 3;
#define C1C2k2 C1C2k2_NaV12
 double C1C2k2 = -10;
#define C1C2v2 C1C2v2_NaV12
 double C1C2v2 = -5;
#define C1C2b2 C1C2b2_NaV12
 double C1C2b2 = 16;
#define I2I1k1 I2I1k1_NaV12
 double I2I1k1 = 15;
#define I2I1v1 I2I1v1_NaV12
 double I2I1v1 = -90;
#define I2I1b1 I2I1b1_NaV12
 double I2I1b1 = 0.017;
#define I1I2k2 I1I2k2_NaV12
 double I1I2k2 = -5;
#define I1I2v2 I1I2v2_NaV12
 double I1I2v2 = -90;
#define I1I2b2 I1I2b2_NaV12
 double I1I2b2 = 0.0022;
#define I1C1k1 I1C1k1_NaV12
 double I1C1k1 = 10;
#define I1C1v1 I1C1v1_NaV12
 double I1C1v1 = -65;
#define I1C1b1 I1C1b1_NaV12
 double I1C1b1 = 0.55;
#define I1O1k1 I1O1k1_NaV12
 double I1O1k1 = 10;
#define I1O1v1 I1O1v1_NaV12
 double I1O1v1 = -42;
#define I1O1b1 I1O1b1_NaV12
 double I1O1b1 = 1e-05;
#define O1I1k2 O1I1k2_NaV12
 double O1I1k2 = -12;
#define O1I1v2 O1I1v2_NaV12
 double O1I1v2 = -11;
#define O1I1b2 O1I1b2_NaV12
 double O1I1b2 = 16;
#define O1I1k1 O1I1k1_NaV12
 double O1I1k1 = 12;
#define O1I1v1 O1I1v1_NaV12
 double O1I1v1 = -41;
#define O1I1b1 O1I1b1_NaV12
 double O1I1b1 = 3;
#define O2C2k2 O2C2k2_NaV12
 double O2C2k2 = -15;
#define O2C2v2 O2C2v2_NaV12
 double O2C2v2 = -10;
#define O2C2b2 O2C2b2_NaV12
 double O2C2b2 = 0.7;
#define O2C2k1 O2C2k1_NaV12
 double O2C2k1 = 6;
#define O2C2v1 O2C2v1_NaV12
 double O2C2v1 = -60;
#define O2C2b1 O2C2b1_NaV12
 double O2C2b1 = 2;
#define O1C2k2 O1C2k2_NaV12
 double O1C2k2 = -10;
#define O1C2v2 O1C2v2_NaV12
 double O1C2v2 = -10;
#define O1C2b2 O1C2b2_NaV12
 double O1C2b2 = 16;
#define O1C2k1 O1C2k1_NaV12
 double O1C2k1 = 10;
#define O1C2v1 O1C2v1_NaV12
 double O1C2v1 = -40;
#define O1C2b1 O1C2b1_NaV12
 double O1C2b1 = 3;
#define gbar gbar_NaV12
 double gbar = 0.045;
#define nao0 nao0_NaV12
 double nao0 = 140;
#define nai0 nai0_NaV12
 double nai0 = 15;
 ...
 "nai0_NaV12", &nai0_NaV12,
 "nao0_NaV12", &nao0_NaV12,
 "gbar_NaV12", &gbar_NaV12,
 "C1C2b2_NaV12", &C1C2b2_NaV12,
 "C1C2v2_NaV12", &C1C2v2_NaV12,
 "C1C2k2_NaV12", &C1C2k2_NaV12,
 "C2C1b1_NaV12", &C2C1b1_NaV12,
 "C2C1v1_NaV12", &C2C1v1_NaV12,
 "C2C1k1_NaV12", &C2C1k1_NaV12,
 "C2C1b2_NaV12", &C2C1b2_NaV12,
 "C2C1v2_NaV12", &C2C1v2_NaV12,
 "C2C1k2_NaV12", &C2C1k2_NaV12,
 "C2O1b2_NaV12", &C2O1b2_NaV12,
 "C2O1v2_NaV12", &C2O1v2_NaV12,
 "C2O1k2_NaV12", &C2O1k2_NaV12,
 "O1C2b1_NaV12", &O1C2b1_NaV12,
 "O1C2v1_NaV12", &O1C2v1_NaV12,
 "O1C2k1_NaV12", &O1C2k1_NaV12,
 "O1C2b2_NaV12", &O1C2b2_NaV12,
 "O1C2v2_NaV12", &O1C2v2_NaV12,
 "O1C2k2_NaV12", &O1C2k2_NaV12,
 "C2O2b2_NaV12", &C2O2b2_NaV12,
 "C2O2v2_NaV12", &C2O2v2_NaV12,
 "C2O2k2_NaV12", &C2O2k2_NaV12,
 "O2C2b1_NaV12", &O2C2b1_NaV12,
 "O2C2v1_NaV12", &O2C2v1_NaV12,
 "O2C2k1_NaV12", &O2C2k1_NaV12,
 "O2C2b2_NaV12", &O2C2b2_NaV12,
 "O2C2v2_NaV12", &O2C2v2_NaV12,
 "O2C2k2_NaV12", &O2C2k2_NaV12,
 "O1I1b1_NaV12", &O1I1b1_NaV12,
 "O1I1v1_NaV12", &O1I1v1_NaV12,
 "O1I1k1_NaV12", &O1I1k1_NaV12,
 "O1I1b2_NaV12", &O1I1b2_NaV12,
 "O1I1v2_NaV12", &O1I1v2_NaV12,
 "O1I1k2_NaV12", &O1I1k2_NaV12,
 "I1O1b1_NaV12", &I1O1b1_NaV12,
 "I1O1v1_NaV12", &I1O1v1_NaV12,
 "I1O1k1_NaV12", &I1O1k1_NaV12,
 "I1C1b1_NaV12", &I1C1b1_NaV12,
 "I1C1v1_NaV12", &I1C1v1_NaV12,
 "I1C1k1_NaV12", &I1C1k1_NaV12,
 "C1I1b2_NaV12", &C1I1b2_NaV12,
 "C1I1v2_NaV12", &C1I1v2_NaV12,
 "C1I1k2_NaV12", &C1I1k2_NaV12,
 "I1I2b2_NaV12", &I1I2b2_NaV12,
 "I1I2v2_NaV12", &I1I2v2_NaV12,
 "I1I2k2_NaV12", &I1I2k2_NaV12,
 "I2I1b1_NaV12", &I2I1b1_NaV12,
 "I2I1v1_NaV12", &I2I1v1_NaV12,
 "I2I1k1_NaV12", &I2I1k1_NaV12,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 NaV12 NaV12.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "NaV12.mod";
static const char* nmodl_file_text = 
  "NEURON {\n"
  "	SUFFIX NaV12 	\n"
